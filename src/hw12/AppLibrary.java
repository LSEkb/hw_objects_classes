...
public class AppLibrary {
    public static void main(String[] args) {
        ...
        System.out.println("AnnaKarenina = " + annaKarenina.getBookName() + " " + annaKarenina.getAuthorName() + " " + annaKarenina.getPublishingYear());
        Book aelita = new Book("Аэлита", alexNTolstoy, 1923);
        System.out.println("Aelita = " + aelita.getBookName() + " " + aelita.getAuthorName() + " " + aelita.getPublishingYear());
        aelita.setPublishingYear(1938);
        System.out.println("Aelita = " + aelita.getPublishingYear() + "переиздание");
